const request = require('request');
  request('https://www.servicos.gov.br/api/v1/servicos?campos=id%2C%20nome%2C%20porcentagemDigital%2C%20servicoDigital%2C%20avaliacoes%2C%20orgao', 
    ...
    var arquivoJson2 =  arquivoJson2.replace(/("{|}")/gi,'"');
    // for( var prop2 in arquivoJson2 ){
    //     if( arquivoJson2[prop2] === undefined || arquivoJson2[prop2] === null)
         
    //     delete arquivoJson2[prop2]
    //     console.log(arquivoJson2[prop2]);
